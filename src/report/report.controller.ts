...
export class ReportController {
    constructor(private readonly reportService: ReportService, private readonly doctorService: DoctorService, private readonly s3Service : S3Service, private readonly patientService: PatientService) {}
